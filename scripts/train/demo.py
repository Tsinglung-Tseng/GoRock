...
os.environ["DB_CONNECTION"] ="postgresql://zengqinglong@192.168.1.96:5432/monolithic_crystal"
...
train_sample = fa_count.expand_dims(2).concatenate_with(fa_sipm_center_pos, 2).shrink((1,2)).rollaxis(1,4).to_tensor()

train_label = FuncArray(sample_df[['gamma_1_x', 'gamma_1_y','gamma_1_z','gamma_2_x','gamma_2_y','gamma_2_z']]).to_tensor()
